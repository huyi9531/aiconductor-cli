...
name: douyin-toolbox
description: |
description: 抖音数据获取与处理工具箱，支持视频详情、评论抓取、用户主页、视频搜索、语音转文字等功能。当用户需要操作抖音数据时使用，例如：(1) 查看某个视频的详细信息或评论，(2) 获取用户主页视频列表或用户资料，(3) 按关键词搜索抖音用户或视频，(4) 将抖音视频语音转为文字，(5) 任何涉及抖音数据提取或分析的任务。
---
